...
# Fix for SciPy NameError in ImageDataGenerator
# This script replaces the problematic ImageDataGenerator with tf.data.Dataset API
...
print("Starting pet dataset classifier with tf.data.Dataset API")
...
print("\nProcess complete! The model has been trained and saved successfully.") 